  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ getUserAddress.fullAddress }}</span>
        收货人：<span>{{ getUserAddress.consignee }}</span>
        <span>{{ getUserAddress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...mapState("trade", ["addressInfo", "order"]),
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.getUserAddress.consignee,
        consigneeTel: this.getUserAddress.phoneNum,
        deliveryAddress: this.getUserAddress.fullAddress,
        paymentWay: "ONLINE",
